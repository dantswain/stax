...
impl Config {
    ...
    fn to_toml_with_comments(&self) -> Result<String> {
        ...
        content.push_str(&format!("default_base_branch = \"{}\"\n", self.default_base_branch));
        content.push('\n');
...
mod tests {
    ...
    fn test_config_default() {
        ...
        assert_eq!(config.auto_push, true);
        assert_eq!(config.draft_prs, false);
    ...
    fn test_config_set_and_get() {
        ...
        assert_eq!(config.draft_prs, true);
        
        config.set("pr_template", "## Summary\n\n## Testing").unwrap();
        assert_eq!(config.pr_template, Some("## Summary\n\n## Testing".to_string()));
        
        config.set("custom_key", "custom_value").unwrap();
        assert_eq!(config.user_settings.get("custom_key"), Some(&"custom_value".to_string()));
    }
    ...
    fn test_config_list() {
        ...
        assert_eq!(settings.get("custom_setting"), Some(&"test_value".to_string()));
    }
    ...
    fn test_toml_generation_with_comments() {
        ...
        config.user_settings.insert("custom_key".to_string(), "custom_value".to_string());
